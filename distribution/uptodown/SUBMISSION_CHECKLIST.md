...
- English and Brazilian Portuguese descriptions and 0.30.0 version notes, positioning opt-in lock-screen Quranic Arabic learning first.
...
- Fill the public organization profile with developer/author name `Uthman (Gustavo)`, support email `uthman-al-brazili@proton.me`, website `https://sites.google.com/view/kalimaapp`, and the developer's nationality.
- Publish `PRIVACY_POLICY.md` as a stable public page on the website and paste its final HTTPS URL into the Uptodown privacy-policy field.
...
- Upload the icon, featured image, and at least four accurate portrait promotional images. Use `promotional/en/` and `promotional/pt-BR/` for the localized public sets.
